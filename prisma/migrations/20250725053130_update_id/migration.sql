...
CREATE TABLE `auto_alarms` (
    `auto_alarm_id` INTEGER NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `remind_rules` (
    `remind_id` INTEGER NOT NULL AUTO_INCREMENT,
    `schedule_id` INTEGER NOT NULL,
...
CREATE TABLE `repeat_weekdays` (
    `repeat_weekday_id` INTEGER NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `user_google_token` (
    ...
    UNIQUE INDEX `user_google_token_user_id_key`(`user_id`),
...
CREATE TABLE `users` (
    ...
    `created_at` TIMESTAMP(0) NULL,
    `updated_at` TIMESTAMP(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
    `remind_is_sound` BOOLEAN NOT NULL DEFAULT true,
    `remind_is_vibrating` BOOLEAN NOT NULL DEFAULT true,
    `remind_sound_id` INTEGER NOT NULL DEFAULT 0,
    `remind_vibration_type` ENUM('default', 'short1', 'short2', 'long1', 'long2') NOT NULL DEFAULT 'default',
...
CREATE TABLE `wakeup_alarms` (
    `wakeup_alarm_id` INTEGER NOT NULL AUTO_INCREMENT,
    `user_id` INTEGER NOT NULL,
