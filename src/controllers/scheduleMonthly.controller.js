import { getMonthlyScheduleDots } from '../services/scheduleMonthly_service.js';
...
export const handleGetMonthlyScheduleDots = async (req, res, next) => {
  try {
    ...
    const result = await getMonthlyScheduleDots(userId, year, month);
